...
function gformInitSpinner(t, r, i = !0) {
    gform.applyFilters("gform_spinner_url", r, t) != r && (i = !0), jQuery("#gform_" + t).submit(function() {
        var e;
...
String.prototype.gformFormat || (String.prototype.gformFormat = function() {
    ...
    var r = arguments;
    return console.warn("String.format will be replaced with String.gformFormat in Gravity Forms version 2.8."), this.replace(/{(\d+)}/g, function(e, t) {
        return void 0 !== r[t] ? r[t] : e
    })
